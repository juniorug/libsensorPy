  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.altitudeSensor-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.altitudeSensor-module.html">Module libsensorPy.abstractclass.altitudeSensor</a></h1>
<pre class="py-src">
...
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="AltitudeSensor-toggle" onclick="return toggle('AltitudeSensor');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.html">AltitudeSensor</a><tt class="py-op">(</tt><tt class="py-base-class">Sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L14"></a><tt class="py-lineno">14</tt>  <tt class="py-line">    <tt id="link-4" class="py-name" targets="Variable libsensorPy.abstractclass.altitudeSensor.AltitudeSensor._SEA_LEVEL_PRESSURE=libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.html#_SEA_LEVEL_PRESSURE"><a title="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor._SEA_LEVEL_PRESSURE" class="py-name" href="#" onclick="return doclink('link-4', '_SEA_LEVEL_PRESSURE', 'link-4');">_SEA_LEVEL_PRESSURE</a></tt> <tt class="py-op">=</tt> <tt class="py-number">101325</tt>  <tt class="py-comment"># sea level pressure in kPa</tt> </tt>
<a name="L15"></a><tt class="py-lineno">15</tt>  <tt class="py-line"> </tt>
<a name="AltitudeSensor.__init__"></a><div id="AltitudeSensor.__init__-def"><a name="L16"></a><tt class="py-lineno">16</tt> <a class="py-toggle" href="#" id="AltitudeSensor.__init__-toggle" onclick="return toggle('AltitudeSensor.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="AltitudeSensor.setup"></a><div id="AltitudeSensor.setup-def"><a name="L23"></a><tt class="py-lineno">23</tt> <a class="py-toggle" href="#" id="AltitudeSensor.setup-toggle" onclick="return toggle('AltitudeSensor.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.html#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="AltitudeSensor.getAltitude"></a><div id="AltitudeSensor.getAltitude-def"><a name="L27"></a><tt class="py-lineno">27</tt> <a class="py-toggle" href="#" id="AltitudeSensor.getAltitude-toggle" onclick="return toggle('AltitudeSensor.getAltitude');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.html#getAltitude">getAltitude</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="AltitudeSensor.getAltitudeInCm"></a><div id="AltitudeSensor.getAltitudeInCm-def"><a name="L31"></a><tt class="py-lineno">31</tt> <a class="py-toggle" href="#" id="AltitudeSensor.getAltitudeInCm-toggle" onclick="return toggle('AltitudeSensor.getAltitudeInCm');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.html#getAltitudeInCm">getAltitudeInCm</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L33"></a><tt class="py-lineno">33</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-7" class="py-name" targets="Method libsensorPy.abstractclass.altitudeSensor.AltitudeSensor.getAltitude()=libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.html#getAltitude,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getAltitude()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.html#getAltitude,Method libsensorPy.concretesensor.bmp085Altitude.BMP085Altitude.getAltitude()=libsensorPy.concretesensor.bmp085Altitude.BMP085Altitude-class.html#getAltitude"><a title="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor.getAltitude
