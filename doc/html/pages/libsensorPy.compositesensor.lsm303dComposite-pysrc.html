  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.compositesensor.lsm303dComposite-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.compositesensor.lsm303dComposite-module.html">Module libsensorPy.compositesensor.lsm303dComposite</a></h1>
<pre class="py-src">
...
<a name="L50"></a><tt class="py-lineno">50</tt>  <tt class="py-line">        <tt class="py-keyword">if</tt> <tt class="py-op">(</tt> <tt class="py-name">isinstance</tt><tt class="py-op">(</tt><tt id="link-22" class="py-name" targets="Module libsensorPy.abstractclass.sensor=libsensorPy.abstractclass.sensor-module.html"><a title="libsensorPy.abstractclass.sensor" class="py-name" href="#" onclick="return doclink('link-22', 'sensor', 'link-22');">sensor</a></tt><tt class="py-op">,</tt> <tt id="link-23" class="py-name"><a title="libsensorPy.concretesensor.lsm303dAccelerometer.LSM303DAccelerometer" class="py-name" href="#" onclick="return doclink('link-23', 'LSM303DAccelerometer', 'link-8');">LSM303DAccelerometer</a></tt><tt class="py-op">)</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
