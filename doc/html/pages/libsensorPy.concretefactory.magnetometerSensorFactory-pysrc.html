  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.concretefactory.magnetometerSensorFactory-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.concretefactory.magnetometerSensorFactory-module.html">Module libsensorPy.concretefactory.magnetometerSensorFactory</a></h1>
<pre class="py-src">
...
<a name="L9"></a><tt class="py-lineno"> 9</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-6" class="py-name"><a title="libsensorPy.concretesensor" class="py-name" href="#" onclick="return doclink('link-6', 'concretesensor', 'link-3');">concretesensor</a></tt><tt class="py-op">.</tt><tt id="link-7" class="py-name" targets="Module libsensorPy.concretesensor.hmc5883l=libsensorPy.concretesensor.hmc5883l-module.html"><a title="libsensorPy.concretesensor.hmc5883l" class="py-name" href="#" onclick="return doclink('link-7', 'hmc5883l', 'link-7');">hmc5883l</a></tt> <tt class="py-keyword">import</tt> <tt id="link-8" class="py-name" targets="Class libsensorPy.concretesensor.hmc5883l.HMC5883L=libsensorPy.concretesensor.hmc5883l.HMC5883L-class.html"><a title="libsensorPy.concretesensor.hmc5883l.HMC5883L" class="py-name" href="#" onclick="return doclink('link-8', 'HMC5883L', 'link-8');">HMC5883L</a></tt> </tt>
