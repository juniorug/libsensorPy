  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.temperatureSensor-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.temperatureSensor-module.html">Module libsensorPy.abstractclass.temperatureSensor</a></h1>
<pre class="py-src">
...
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="TemperatureSensor-toggle" onclick="return toggle('TemperatureSensor');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html">TemperatureSensor</a><tt class="py-op">(</tt><tt class="py-base-class">Sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="TemperatureSensor.__init__"></a><div id="TemperatureSensor.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="TemperatureSensor.__init__-toggle" onclick="return toggle('TemperatureSensor.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="TemperatureSensor.setup"></a><div id="TemperatureSensor.setup-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="TemperatureSensor.setup-toggle" onclick="return toggle('TemperatureSensor.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="TemperatureSensor.getTemperature"></a><div id="TemperatureSensor.getTemperature-def"><a name="L26"></a><tt class="py-lineno">26</tt> <a class="py-toggle" href="#" id="TemperatureSensor.getTemperature-toggle" onclick="return toggle('TemperatureSensor.getTemperature');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#getTemperature">getTemperature</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="TemperatureSensor.getTemperatureInFahrenheit"></a><div id="TemperatureSensor.getTemperatureInFahrenheit-def"><a name="L30"></a><tt class="py-lineno">30</tt> <a class="py-toggle" href="#" id="TemperatureSensor.getTemperatureInFahrenheit-toggle" onclick="return toggle('TemperatureSensor.getTemperatureInFahrenheit');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#getTemperatureInFahrenheit">getTemperatureInFahrenheit</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="TemperatureSensor._bin2dec"></a><div id="TemperatureSensor._bin2dec-def"><a name="L38"></a><tt class="py-lineno">38</tt> <a class="py-toggle" href="#" id="TemperatureSensor._bin2dec-toggle" onclick="return toggle('TemperatureSensor._bin2dec');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#_bin2dec">_bin2dec</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">string_num</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
