  ...
  <tr valign="top">
    <td width="100%">
      <span class="breadcrumbs">
        ...
        <a href="libsensorPy.concretesensor.bmp085Pressure-module.html">Module&nbsp;bmp085Pressure</a> ::
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class BMP085Pressure</h1><p class="nomargin-top"><span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure">source&nbsp;code</a></span></p>
<center>
<center>  <map id="uml_class_diagram_for_libsenso_40" name="uml_class_diagram_for_libsenso_40">
<area shape="rect" id="node90" href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#__init__" title="Constructor" alt="" coords="40,263,267,281"/>
<area shape="rect" id="node90" href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#setup" title="Setup the GPIO." alt="" coords="40,281,267,300"/>
<area shape="rect" id="node90" href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#changeSetup" title="changes GPIO setup ." alt="" coords="40,300,267,319"/>
<area shape="rect" id="node90" href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#getPressure" title="Gets the compensated pressure in pascal." alt="" coords="40,319,267,337"/>
<area shape="rect" id="node1" href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html" title="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure" alt="" coords="28,230,279,343"/>
<area shape="rect" id="node91" href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html#__metaclass__" title="libsensorPy.abstractclass.pressureSensor.PressureSensor.__metaclass__" alt="" coords="17,108,289,127"/>
<area shape="rect" id="node91" href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html#getPressureInPsi" title="Return the pressure in psi." alt="" coords="17,129,289,148"/>
<area shape="rect" id="node91" href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html#getPressureInBar" title="Return the pressure in psi." alt="" coords="17,148,289,167"/>
<area shape="rect" id="node91" href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html#getPressureInMmhg" title="Return the pressure in psi." alt="" coords="17,167,289,185"/>
<area shape="rect" id="node91" href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html#getPressureInNm2" title="Return the pressure in psi." alt="" coords="17,185,289,204"/>
<area shape="rect" id="node2" href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html" title="classdocs" alt="" coords="5,83,301,210"/>
<area shape="rect" id="node92" href="libsensorPy.abstractclass.sensor.Sensor-class.html#__del__" title="We&#39;re no longer using the GPIO, so tell software we&#39;re done." alt="" coords="69,39,237,57"/>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>,
      ...
      Constructor</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure.__init__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#setup" class="summary-sig-name">setup</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">address</span>=<span class="summary-sig-default">0x77</span>,
        <span class="summary-sig-arg">mode</span>=<span class="summary-sig-default">3</span>)</span><br />
      Setup the GPIO.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure.setup">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#changeSetup" class="summary-sig-name">changeSetup</a>(<span class="summary-sig-arg">self</span>)</span><br />
      changes GPIO setup .</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure.changeSetup">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      Reads the calibration data from the IC.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure.__readCalibrationData">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      Reads the raw (uncompensated) temperature from the sensor.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure.__readRawTemp">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      Reads the raw (uncompensated) pressure level from the sensor.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure.__readRawPressure">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#getPressure" class="summary-sig-name">getPressure</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Gets the compensated pressure in pascal.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.bmp085Pressure-pysrc.html#BMP085Pressure.getPressure">source&nbsp;code</a></span>
...
<tr class="private">
  ...
  <tr>
    <td colspan="2" class="summary">
    <p class="indent-wrapped-lines"><b>Inherited from <code><a href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html">abstractclass.pressureSensor.PressureSensor</a></code></b>:
      <code><a href="libsensorPy.abstractclass.pressureSensor.PressureSensor-class.html#__metaclass__">__metaclass__</a></code>
      </p>
    </td>
  </tr>
</table>
