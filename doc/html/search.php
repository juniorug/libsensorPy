...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Search &mdash; libsensorPy 0.0.4 documentation</title>
    ...
    <script type="text/javascript" src="<?=$siteUrl?>/js/searchtools.js"></script>
    <link rel="top" title="libsensorPy 0.0.4 documentation" href="documentation" />
  <script type="text/javascript">
