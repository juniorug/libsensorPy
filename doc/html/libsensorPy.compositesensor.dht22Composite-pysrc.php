  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.compositesensor.dht22Composite-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.compositesensor.dht22Composite-module.html">Module libsensorPy.compositesensor.dht22Composite</a></h1>
<pre class="py-src">
...
<a name="L7"></a><tt class="py-lineno"> 7</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-3" class="py-name"><a title="libsensorPy.abstractclass" class="py-name" href="#" onclick="return doclink('link-3', 'abstractclass', 'link-0');">abstractclass</a></tt><tt class="py-op">.</tt><tt id="link-4" class="py-name" targets="Module libsensorPy.abstractclass.temperatureSensor=libsensorPy.abstractclass.temperatureSensor-module.html"><a title="libsensorPy.abstractclass.temperatureSensor" class="py-name" href="#" onclick="return doclink('link-4', 'temperatureSensor', 'link-4');">temperatureSensor</a></tt> <tt class="py-keyword">import</tt> <tt id="link-5" class="py-name" targets="Class libsensorPy.abstractclass.temperatureSensor.TemperatureSensor=libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html"><a title="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor" class="py-name" href="#" onclick="return doclink('link-5', 'TemperatureSensor', 'link-5');">TemperatureSensor</a></tt> </tt>
<a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-6" class="py-name" targets="Package libsensorPy.concretesensor=libsensorPy.concretesensor-module.html"><a title="libsensorPy.concretesensor" class="py-name" href="#" onclick="return doclink('link-6', 'concretesensor', 'link-6');">concretesensor</a></tt><tt class="py-op">.</tt><tt id="link-7" class="py-name" targets="Module libsensorPy.concretesensor.dht22Humidity=libsensorPy.concretesensor.dht22Humidity-module.html"><a title="libsensorPy.concretesensor.dht22Humidity" class="py-name" href="#" onclick="return doclink('link-7', 'dht22Humidity', 'link-7');">dht22Humidity</a></tt> <tt class="py-keyword">import</tt> <tt id="link-8" class="py-name" targets="Class libsensorPy.concretesensor.dht22Humidity.DHT22Humidity=libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.html"><a title="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity" class="py-name" href="#" onclick="return doclink('link-8', 'DHT22Humidity', 'link-8');">DHT22Humidity</a></tt> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-9" class="py-name"><a title="libsensorPy.concretesensor" class="py-name" href="#" onclick="return doclink('link-9', 'concretesensor', 'link-6');">concretesensor</a></tt><tt class="py-op">.</tt><tt id="link-10" class="py-name" targets="Module libsensorPy.concretesensor.dht22Temperature=libsensorPy.concretesensor.dht22Temperature-module.html"><a title="libsensorPy.concretesensor.dht22Temperature" class="py-name" href="#" onclick="return doclink('link-10', 'dht22Temperature', 'link-10');">dht22Temperature</a></tt> <tt class="py-keyword">import</tt> <tt id="link-11" class="py-name" targets="Class libsensorPy.concretesensor.dht22Temperature.DHT22Temperature=libsensorPy.concretesensor.dht22Temperature.DHT22Temperature-class.html"><a title="libsensorPy.concretesensor.dht22Temperature.DHT22Temperature" class="py-name" href="#" onclick="return doclink('link-11', 'DHT22Temperature', 'link-11');">DHT22Temperature</a></tt> </tt>
<a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line"> </tt>
<a name="DHT22Composite"></a><div id="DHT22Composite-def"><a name="L11"></a><tt class="py-lineno">11</tt> <a class="py-toggle" href="#" id="DHT22Composite-toggle" onclick="return toggle('DHT22Composite');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html">DHT22Composite</a><tt class="py-op">(</tt><tt class="py-base-class">TemperatureSensor</tt><tt class="py-op">,</tt><tt class="py-base-class">HumiditySensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="DHT22Composite.__init__"></a><div id="DHT22Composite.__init__-def"><a name="L16"></a><tt class="py-lineno">16</tt> <a class="py-toggle" href="#" id="DHT22Composite.__init__-toggle" onclick="return toggle('DHT22Composite.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="DHT22Composite.setup"></a><div id="DHT22Composite.setup-def"><a name="L25"></a><tt class="py-lineno">25</tt> <a class="py-toggle" href="#" id="DHT22Composite.setup-toggle" onclick="return toggle('DHT22Composite.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="DHT22Composite.changeSetup"></a><div id="DHT22Composite.changeSetup-def"><a name="L29"></a><tt class="py-lineno">29</tt> <a class="py-toggle" href="#" id="DHT22Composite.changeSetup-toggle" onclick="return toggle('DHT22Composite.changeSetup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#changeSetup">changeSetup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">pin</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L35"></a><tt class="py-lineno">35</tt>  <tt class="py-line">        <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Temp</tt><tt class="py-op">.</tt><tt id="link-19" class="py-name" targets="Method libsensorPy.abstractclass.actuator.Actuator.changeSetup()=libsensorPy.abstractclass.actuator.Actuator-class.html#changeSetup,Method libsensorPy.abstractclass.sensor.Sensor.changeSetup()=libsensorPy.abstractclass.sensor.Sensor-class.html#changeSetup,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.changeSetup()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.html#changeSetup,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.changeSetup()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.html#changeSetup,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.changeSetup()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#changeSetup,Method libsensorPy.compositesensor.lsm303dComposite.LSM303DComposite.changeSetup()=libsensorPy.compositesensor.lsm303dComposite.LSM303DComposite-class.html#changeSetup,Method libsensorPy.concreteactuator.stepper28BJY48.Stepper28BJY48.changeSetup()=libsensorPy.concreteactuator.stepper28BJY48.Stepper28BJY48-class.html#changeSetup,Method libsensorPy.concretesensor.adxl345.ADXL345.changeSetup()=libsensorPy.concretesensor.adxl345.ADXL345-class.html#changeSetup,Method libsensorPy.concretesensor.bmp085Altitude.BMP085Altitude.changeSetup()=libsensorPy.concretesensor.bmp085Altitude.BMP085Altitude-class.html#changeSetup,Method libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure.changeSetup()=libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html#changeSetup,Method libsensorPy.concretesensor.bmp085Temperature.BMP085Temperature.changeSetup()=libsensorPy.concretesensor.bmp085Temperature.BMP085Temperature-class.html#changeSetup,Method libsensorPy.concretesensor.dht11Humidity.DHT11Humidity.changeSetup()=libsensorPy.concretesensor.dht11Humidity.DHT11Humidity-class.html#changeSetup,Method libsensorPy.concretesensor.dht11Temperature.DHT11Temperature.changeSetup()=libsensorPy.concretesensor.dht11Temperature.DHT11Temperature-class.html#changeSetup,Method libsensorPy.concretesensor.dht22Humidity.DHT22Humidity.changeSetup()=libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.html#changeSetup,Method libsensorPy.concretesensor.dht22Temperature.DHT22Temperature.changeSetup()=libsensorPy.concretesensor.dht22Temperature.DHT22Temperature-class.html#changeSetup,Method libsensorPy.concretesensor.hmc5883l.HMC5883L.changeSetup()=libsensorPy.concretesensor.hmc5883l.HMC5883L-class.html#changeSetup,Method libsensorPy.concretesensor.hysrf05.HYSRF05.changeSetup()=libsensorPy.concretesensor.hysrf05.HYSRF05-class.html#changeSetup,Method libsensorPy.concretesensor.lsm303dAccelerometer.LSM303DAccelerometer.changeSetup()=libsensorPy.concretesensor.lsm303dAccelerometer.LSM303DAccelerometer-class.html#changeSetup,Method libsensorPy.concretesensor.lsm303dMagnetometer.LSM303DMagnetometer.changeSetup()=libsensorPy.concretesensor.lsm303dMagnetometer.LSM303DMagnetometer-class.html#changeSetup,Method libsensorPy.concretesensor.parallaxPing.ParallaxPing.changeSetup()=libsensorPy.concretesensor.parallaxPing.ParallaxPing-class.html#changeSetup,Method libsensorPy.concretesensor.pir.PIR.changeSetup()=libsensorPy.concretesensor.pir.PIR-class.html#changeSetup,Method libsensorPy.concretesensor.srf04.SRF04.changeSetup()=libsensorPy.concretesensor.srf04.SRF04-class.html#changeSetup,Method libsensorPy.concretesensor.srf05.SRF05.changeSetup()=libsensorPy.concretesensor.srf05.SRF05-class.html#changeSetup,Method libsensorPy.concretesensor.tcs34725.TCS34725.changeSetup()=libsensorPy.concretesensor.tcs34725.TCS34725-class.html#changeSetup,Method libsensorPy.concretesensor.urm37.URM37.changeSetup()=libsensorPy.concretesensor.urm37.URM37-class.html#changeSetup,Method libsensorPy.extension.hcsr04.HCSR04.changeSetup()=libsensorPy.extension.hcsr04.HCSR04-class.html#changeSetup"><a title="libsensorPy.abstractclass.actuator.Actuator.changeSetup
...
<a name="DHT22Composite.getTemperature"></a><div id="DHT22Composite.getTemperature-def"><a name="L37"></a><tt class="py-lineno">37</tt> <a class="py-toggle" href="#" id="DHT22Composite.getTemperature-toggle" onclick="return toggle('DHT22Composite.getTemperature');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#getTemperature">getTemperature</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L39"></a><tt class="py-lineno">39</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht122Temp</tt><tt class="py-op">.</tt><tt id="link-20" class="py-name" targets="Method libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperature()=libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#getTemperature,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getTemperature()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.html#getTemperature,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.getTemperature()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.html#getTemperature,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.getTemperature()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#getTemperature,Method libsensorPy.concreteevent.temperatureEvent.TemperatureEvent.getTemperature()=libsensorPy.concreteevent.temperatureEvent.TemperatureEvent-class.html#getTemperature,Method libsensorPy.concretesensor.bmp085Temperature.BMP085Temperature.getTemperature()=libsensorPy.concretesensor.bmp085Temperature.BMP085Temperature-class.html#getTemperature,Method libsensorPy.concretesensor.dht11Temperature.DHT11Temperature.getTemperature()=libsensorPy.concretesensor.dht11Temperature.DHT11Temperature-class.html#getTemperature,Method libsensorPy.concretesensor.dht22Temperature.DHT22Temperature.getTemperature()=libsensorPy.concretesensor.dht22Temperature.DHT22Temperature-class.html#getTemperature"><a title="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperature
...
<a name="DHT22Composite.getTemperatureInFahrenheit"></a><div id="DHT22Composite.getTemperatureInFahrenheit-def"><a name="L41"></a><tt class="py-lineno">41</tt> <a class="py-toggle" href="#" id="DHT22Composite.getTemperatureInFahrenheit-toggle" onclick="return toggle('DHT22Composite.getTemperatureInFahrenheit');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#getTemperatureInFahrenheit">getTemperatureInFahrenheit</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L43"></a><tt class="py-lineno">43</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Temp</tt><tt class="py-op">.</tt><tt id="link-21" class="py-name" targets="Method libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInFahrenheit()=libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#getTemperatureInFahrenheit,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getTemperatureInFahrenheit()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.html#getTemperatureInFahrenheit,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.getTemperatureInFahrenheit()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.html#getTemperatureInFahrenheit,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.getTemperatureInFahrenheit()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#getTemperatureInFahrenheit"><a title="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInFahrenheit
...
<a name="L47"></a><tt class="py-lineno">47</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Temp</tt><tt class="py-op">.</tt><tt id="link-22" class="py-name" targets="Method libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInKelvin()=libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.html#getTemperatureInKelvin,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getTemperatureInKelvin()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.html#getTemperatureInKelvin,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.getTemperatureInKelvin()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.html#getTemperatureInKelvin,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.getTemperatureInKelvin()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#getTemperatureInKelvin"><a title="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInKelvin
...
<a name="DHT22Composite.getHumidity"></a><div id="DHT22Composite.getHumidity-def"><a name="L49"></a><tt class="py-lineno">49</tt> <a class="py-toggle" href="#" id="DHT22Composite.getHumidity-toggle" onclick="return toggle('DHT22Composite.getHumidity');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#getHumidity">getHumidity</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L51"></a><tt class="py-lineno">51</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Hum</tt><tt class="py-op">.</tt><tt id="link-23" class="py-name" targets="Method libsensorPy.abstractclass.humiditySensor.HumiditySensor.getHumidity()=libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.html#getHumidity,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.getHumidity()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.html#getHumidity,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.getHumidity()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#getHumidity,Method libsensorPy.concretesensor.dht11Humidity.DHT11Humidity.getHumidity()=libsensorPy.concretesensor.dht11Humidity.DHT11Humidity-class.html#getHumidity,Method libsensorPy.concretesensor.dht22Humidity.DHT22Humidity.getHumidity()=libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.html#getHumidity"><a title="libsensorPy.abstractclass.humiditySensor.HumiditySensor.getHumidity
...
<a name="DHT22Composite.add"></a><div id="DHT22Composite.add-def"><a name="L53"></a><tt class="py-lineno">53</tt> <a class="py-toggle" href="#" id="DHT22Composite.add-toggle" onclick="return toggle('DHT22Composite.add');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.html#add">add</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L60"></a><tt class="py-lineno">60</tt>  <tt class="py-line">        <tt class="py-keyword">if</tt> <tt class="py-op">(</tt> <tt class="py-name">isinstance</tt><tt class="py-op">(</tt><tt id="link-24" class="py-name" targets="Module libsensorPy.abstractclass.sensor=libsensorPy.abstractclass.sensor-module.html"><a title="libsensorPy.abstractclass.sensor" class="py-name" href="#" onclick="return doclink('link-24', 'sensor', 'link-24');">sensor</a></tt><tt class="py-op">,</tt> <tt id="link-25" class="py-name"><a title="libsensorPy.concretesensor.dht22Temperature.DHT22Temperature" class="py-name" href="#" onclick="return doclink('link-25', 'DHT22Temperature', 'link-11');">DHT22Temperature</a></tt><tt class="py-op">)</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
