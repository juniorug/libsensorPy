  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.stepperMotorActuator-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.stepperMotorActuator-module.html">Module libsensorPy.abstractclass.stepperMotorActuator</a></h1>
<pre class="py-src">
...
<a name="L7"></a><tt class="py-lineno"> 7</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-0" class="py-name" targets="Module libsensorPy.abstractclass.motorActuator=libsensorPy.abstractclass.motorActuator-module.html"><a title="libsensorPy.abstractclass.motorActuator" class="py-name" href="#" onclick="return doclink('link-0', 'motorActuator', 'link-0');">motorActuator</a></tt> <tt class="py-keyword">import</tt> <tt id="link-1" class="py-name" targets="Class libsensorPy.abstractclass.motorActuator.MotorActuator=libsensorPy.abstractclass.motorActuator.MotorActuator-class.html"><a title="libsensorPy.abstractclass.motorActuator.MotorActuator" class="py-name" href="#" onclick="return doclink('link-1', 'MotorActuator', 'link-1');">MotorActuator</a></tt> </tt>
<a name="StepperMotorActuator"></a><div id="StepperMotorActuator-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="StepperMotorActuator-toggle" onclick="return toggle('StepperMotorActuator');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.html">StepperMotorActuator</a><tt class="py-op">(</tt><tt class="py-base-class">MotorActuator</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="StepperMotorActuator.__init__"></a><div id="StepperMotorActuator.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="StepperMotorActuator.__init__-toggle" onclick="return toggle('StepperMotorActuator.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="StepperMotorActuator.setStepSequence"></a><div id="StepperMotorActuator.setStepSequence-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="StepperMotorActuator.setStepSequence-toggle" onclick="return toggle('StepperMotorActuator.setStepSequence');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.html#setStepSequence">setStepSequence</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">stepSequence</tt> <tt class="py-op">=</tt> <tt class="py-number">8</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="StepperMotorActuator.setDirectionAndVelocity"></a><div id="StepperMotorActuator.setDirectionAndVelocity-def"><a name="L31"></a><tt class="py-lineno">31</tt> <a class="py-toggle" href="#" id="StepperMotorActuator.setDirectionAndVelocity-toggle" onclick="return toggle('StepperMotorActuator.setDirectionAndVelocity');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.html#setDirectionAndVelocity">setDirectionAndVelocity</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">stepDir</tt> <tt class="py-op">=</tt> <tt class="py-number">2</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
