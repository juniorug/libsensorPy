  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.examples.adxl345Example-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.examples.adxl345Example-module.html">Module libsensorPy.examples.adxl345Example</a></h1>
<pre class="py-src">
...
<a name="L11"></a><tt class="py-lineno">11</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"ADXL345 on address 0x%x:"</tt> <tt class="py-op">%</tt> <tt class="py-op">(</tt><tt id="link-8" class="py-name"><a title="libsensorPy.concretesensor.adxl345" class="py-name" href="#" onclick="return doclink('link-8', 'adxl345', 'link-3');">adxl345</a></tt><tt class="py-op">.</tt><tt id="link-9" class="py-name" targets="Variable libsensorPy.concretesensor.adxl345.ADXL345.address=libsensorPy.concretesensor.adxl345.ADXL345-class.html#address"><a title="libsensorPy.concretesensor.adxl345.ADXL345.address" class="py-name" href="#" onclick="return doclink('link-9', 'address', 'link-9');">address</a></tt><tt class="py-op">)</tt><tt class="py-op">)</tt> </tt>
