  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.dcMotorActuator-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.dcMotorActuator-module.html">Module libsensorPy.abstractclass.dcMotorActuator</a></h1>
<pre class="py-src">
...
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="DCMotorActuator-toggle" onclick="return toggle('DCMotorActuator');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.html">DCMotorActuator</a><tt class="py-op">(</tt><tt class="py-base-class">MotorActuator</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="DCMotorActuator.__init__"></a><div id="DCMotorActuator.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="DCMotorActuator.__init__-toggle" onclick="return toggle('DCMotorActuator.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="DCMotorActuator.setStepSequence"></a><div id="DCMotorActuator.setStepSequence-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="DCMotorActuator.setStepSequence-toggle" onclick="return toggle('DCMotorActuator.setStepSequence');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.html#setStepSequence">setStepSequence</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">stepSequence</tt> <tt class="py-op">=</tt> <tt class="py-number">8</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="DCMotorActuator.setDirection"></a><div id="DCMotorActuator.setDirection-def"><a name="L30"></a><tt class="py-lineno">30</tt> <a class="py-toggle" href="#" id="DCMotorActuator.setDirection-toggle" onclick="return toggle('DCMotorActuator.setDirection');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.html#setDirection">setDirection</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">direction</tt> <tt class="py-op">=</tt> <tt class="py-number">1</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
