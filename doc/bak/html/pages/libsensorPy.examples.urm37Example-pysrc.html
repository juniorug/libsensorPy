  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.examples.urm37Example-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.examples.urm37Example-module.html">Module libsensorPy.examples.urm37Example</a></h1>
<pre class="py-src">
...
<a name="L12"></a><tt class="py-lineno">12</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Distance in cm:"</tt> <tt class="py-op">+</tt> <tt id="link-6" class="py-name"><a title="libsensorPy.concretesensor.urm37" class="py-name" href="#" onclick="return doclink('link-6', 'urm37', 'link-3');">urm37</a></tt><tt class="py-op">.</tt><tt id="link-7" class="py-name" targets="Method libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_cm()=libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor-class.html#distance_in_cm,Method libsensorPy.concretesensor.hysrf05.HYSRF05.distance_in_cm()=libsensorPy.concretesensor.hysrf05.HYSRF05-class.html#distance_in_cm,Method libsensorPy.concretesensor.parallaxPing.ParallaxPing.distance_in_cm()=libsensorPy.concretesensor.parallaxPing.ParallaxPing-class.html#distance_in_cm,Method libsensorPy.concretesensor.srf04.SRF04.distance_in_cm()=libsensorPy.concretesensor.srf04.SRF04-class.html#distance_in_cm,Method libsensorPy.concretesensor.srf05.SRF05.distance_in_cm()=libsensorPy.concretesensor.srf05.SRF05-class.html#distance_in_cm,Method libsensorPy.concretesensor.urm37.URM37.distance_in_cm()=libsensorPy.concretesensor.urm37.URM37-class.html#distance_in_cm,Method libsensorPy.extension.hcsr04.HCSR04.distance_in_cm()=libsensorPy.extension.hcsr04.HCSR04-class.html#distance_in_cm"><a title="libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_cm
...
<a name="L13"></a><tt class="py-lineno">13</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Distance in inches:"</tt> <tt class="py-op">+</tt> <tt id="link-8" class="py-name"><a title="libsensorPy.concretesensor.urm37" class="py-name" href="#" onclick="return doclink('link-8', 'urm37', 'link-3');">urm37</a></tt><tt class="py-op">.</tt><tt id="link-9" class="py-name" targets="Method libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_inches()=libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor-class.html#distance_in_inches"><a title="libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_inches" class="py-name" href="#" onclick="return doclink('link-9', 'distance_in_inches', 'link-9');">distance_in_inches</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt> <tt class="py-op">+</tt> <tt class="py-string">" in"</tt><tt class="py-op">)</tt> </tt>
