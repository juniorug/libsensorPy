  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.concreteevent.temperatureEvent-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.concreteevent.temperatureEvent-module.html">Module libsensorPy.concreteevent.temperatureEvent</a></h1>
<pre class="py-src">
...
<a name="TemperatureEvent.__init__"></a><div id="TemperatureEvent.__init__-def"><a name="L10"></a><tt class="py-lineno">10</tt> <a class="py-toggle" href="#" id="TemperatureEvent.__init__-toggle" onclick="return toggle('TemperatureEvent.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concreteevent.temperatureEvent.TemperatureEvent-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L17"></a><tt class="py-lineno">17</tt>  <tt class="py-line">        <tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-6" class="py-name" targets="Method libsensorPy.concreteevent.temperatureEvent.TemperatureEvent.set_measurement()=libsensorPy.concreteevent.temperatureEvent.TemperatureEvent-class.html#set_measurement"><a title="libsensorPy.concreteevent.temperatureEvent.TemperatureEvent.set_measurement" class="py-name" href="#" onclick="return doclink('link-6', 'set_measurement', 'link-6');">set_measurement</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt> </tt>
</div><a name="L18"></a><tt class="py-lineno">18</tt>  <tt class="py-line"> </tt>
<a name="TemperatureEvent.set_measurement"></a><div id="TemperatureEvent.set_measurement-def"><a name="L19"></a><tt class="py-lineno">19</tt> <a class="py-toggle" href="#" id="TemperatureEvent.set_measurement-toggle" onclick="return toggle('TemperatureEvent.set_measurement');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concreteevent.temperatureEvent.TemperatureEvent-class.html#set_measurement">set_measurement</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L23"></a><tt class="py-lineno">23</tt>  <tt class="py-line">        <tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-8" class="py-name" targets="Method libsensorPy.abstractclass.abstractEvent.AbstractEvent.notify_observers()=libsensorPy.abstractclass.abstractEvent.AbstractEvent-class.html#notify_observers"><a title="libsensorPy.abstractclass.abstractEvent.AbstractEvent.notify_observers" class="py-name" href="#" onclick="return doclink('link-8', 'notify_observers', 'link-8');">notify_observers</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt> </tt>
</div><a name="L24"></a><tt class="py-lineno">24</tt>  <tt class="py-line"> </tt>
<a name="L25"></a><tt class="py-lineno">25</tt>  <tt class="py-line"> </tt>
<a name="TemperatureEvent.getTemperature"></a><div id="TemperatureEvent.getTemperature-def"><a name="L26"></a><tt class="py-lineno">26</tt> <a class="py-toggle" href="#" id="TemperatureEvent.getTemperature-toggle" onclick="return toggle('TemperatureEvent.getTemperature');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concreteevent.temperatureEvent.TemperatureEvent-class.html#getTemperature">getTemperature</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
