  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.servoMotorActuator-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.servoMotorActuator-module.html">Module libsensorPy.abstractclass.servoMotorActuator</a></h1>
<pre class="py-src">
...
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="ServoMotorActuator-toggle" onclick="return toggle('ServoMotorActuator');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.servoMotorActuator.ServoMotorActuator-class.html">ServoMotorActuator</a><tt class="py-op">(</tt><tt class="py-base-class">MotorActuator</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="ServoMotorActuator.__init__"></a><div id="ServoMotorActuator.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="ServoMotorActuator.__init__-toggle" onclick="return toggle('ServoMotorActuator.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.servoMotorActuator.ServoMotorActuator-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="ServoMotorActuator.setDirection"></a><div id="ServoMotorActuator.setDirection-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="ServoMotorActuator.setDirection-toggle" onclick="return toggle('ServoMotorActuator.setDirection');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.servoMotorActuator.ServoMotorActuator-class.html#setDirection">setDirection</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">stepDir</tt> <tt class="py-op">=</tt> <tt class="py-number">2</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="ServoMotorActuator.setAngle"></a><div id="ServoMotorActuator.setAngle-def"><a name="L31"></a><tt class="py-lineno">31</tt> <a class="py-toggle" href="#" id="ServoMotorActuator.setAngle-toggle" onclick="return toggle('ServoMotorActuator.setAngle');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.servoMotorActuator.ServoMotorActuator-class.html#setAngle">setAngle</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">angle</tt> <tt class="py-op">=</tt> <tt class="py-number">2.5</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
