  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.concretesensor.pir-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.concretesensor.pir-module.html">Module libsensorPy.concretesensor.pir</a></h1>
<pre class="py-src">
...
<a name="L9"></a><tt class="py-lineno"> 9</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-0" class="py-name" targets="Package libsensorPy.abstractclass=libsensorPy.abstractclass-module.html"><a title="libsensorPy.abstractclass" class="py-name" href="#" onclick="return doclink('link-0', 'abstractclass', 'link-0');">abstractclass</a></tt><tt class="py-op">.</tt><tt id="link-1" class="py-name" targets="Module libsensorPy.abstractclass.motionSensor=libsensorPy.abstractclass.motionSensor-module.html"><a title="libsensorPy.abstractclass.motionSensor" class="py-name" href="#" onclick="return doclink('link-1', 'motionSensor', 'link-1');">motionSensor</a></tt> <tt class="py-keyword">import</tt> <tt id="link-2" class="py-name" targets="Class libsensorPy.abstractclass.motionSensor.MotionSensor=libsensorPy.abstractclass.motionSensor.MotionSensor-class.html"><a title="libsensorPy.abstractclass.motionSensor.MotionSensor" class="py-name" href="#" onclick="return doclink('link-2', 'MotionSensor', 'link-2');">MotionSensor</a></tt> </tt>
<a name="PIR"></a><div id="PIR-def"><a name="L10"></a><tt class="py-lineno">10</tt> <a class="py-toggle" href="#" id="PIR-toggle" onclick="return toggle('PIR');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.concretesensor.pir.PIR-class.html">PIR</a><tt class="py-op">(</tt><tt class="py-base-class">MotionSensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="PIR.__init__"></a><div id="PIR.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="PIR.__init__-toggle" onclick="return toggle('PIR.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.pir.PIR-class.html#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">pin</tt><tt class="py-op">=</tt><tt class="py-number">7</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="PIR.setup"></a><div id="PIR.setup-def"><a name="L23"></a><tt class="py-lineno">23</tt> <a class="py-toggle" href="#" id="PIR.setup-toggle" onclick="return toggle('PIR.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.pir.PIR-class.html#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="PIR.changeSetup"></a><div id="PIR.changeSetup-def"><a name="L33"></a><tt class="py-lineno">33</tt> <a class="py-toggle" href="#" id="PIR.changeSetup-toggle" onclick="return toggle('PIR.changeSetup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.pir.PIR-class.html#changeSetup">changeSetup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">pin</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="PIR.isMotionDetected"></a><div id="PIR.isMotionDetected-def"><a name="L40"></a><tt class="py-lineno">40</tt> <a class="py-toggle" href="#" id="PIR.isMotionDetected-toggle" onclick="return toggle('PIR.isMotionDetected');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.pir.PIR-class.html#isMotionDetected">isMotionDetected</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
