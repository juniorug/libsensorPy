  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.concretefactory.pressureSensorFactory-pysrc.html"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.concretefactory.pressureSensorFactory-module.html">Module libsensorPy.concretefactory.pressureSensorFactory</a></h1>
<pre class="py-src">
...
<a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-3" class="py-name" targets="Package libsensorPy.concretesensor=libsensorPy.concretesensor-module.html"><a title="libsensorPy.concretesensor" class="py-name" href="#" onclick="return doclink('link-3', 'concretesensor', 'link-3');">concretesensor</a></tt><tt class="py-op">.</tt><tt id="link-4" class="py-name" targets="Module libsensorPy.concretesensor.bmp085Pressure=libsensorPy.concretesensor.bmp085Pressure-module.html"><a title="libsensorPy.concretesensor.bmp085Pressure" class="py-name" href="#" onclick="return doclink('link-4', 'bmp085Pressure', 'link-4');">bmp085Pressure</a></tt> <tt class="py-keyword">import</tt> <tt id="link-5" class="py-name" targets="Class libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure=libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure-class.html"><a title="libsensorPy.concretesensor.bmp085Pressure.BMP085Pressure" class="py-name" href="#" onclick="return doclink('link-5', 'BMP085Pressure', 'link-5');">BMP085Pressure</a></tt> </tt>
<a name="PressureSensorFactory"></a><div id="PressureSensorFactory-def"><a name="L9"></a><tt class="py-lineno"> 9</tt>  <tt class="py-line"> </tt>
<a name="L10"></a><tt class="py-lineno">10</tt> <a class="py-toggle" href="#" id="PressureSensorFactory-toggle" onclick="return toggle('PressureSensorFactory');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.concretefactory.pressureSensorFactory.PressureSensorFactory-class.html">PressureSensorFactory</a><tt class="py-op">(</tt><tt class="py-base-class">AbstractSensorFactory</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
